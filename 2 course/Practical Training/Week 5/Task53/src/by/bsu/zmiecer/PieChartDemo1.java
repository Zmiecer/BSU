    ...
    */
    ...
    private PieDataset createDataset() {
        ...
        try {
            ...
            File file = new File("C:\\Users\\Дмитрий\\Документы\\GitHub\\BSU\\2 course\\Practical Training\\Week 5\\Task53\\input.txt");
    ...
    private static JFreeChart createChart(PieDataset dataset) {
        ...
        JFreeChart chart = ChartFactory.createPieChart(
            "Количество выполненных лабораторных работ",  // chart title
            dataset,            // data
            false,              // no legend
            true,               // tooltips
        ...
        chart.setBackgroundPaint(new GradientPaint(new Point(0, 0), 
                new Color(0, 255, 11), new Point(400, 200), Color.BLUE));
