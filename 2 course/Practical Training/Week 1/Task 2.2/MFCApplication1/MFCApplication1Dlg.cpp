...
BEGIN_EVENTSINK_MAP(CMFCApplication1Dlg, CDialogEx)
	ON_EVENT(CMFCApplication1Dlg, IDC_MSFLEXGRID1, DISPID_KEYUP, CMFCApplication1Dlg::KeyUpMsflexgrid1, VTS_PI2 VTS_I2)
END_EVENTSINK_MAP()


void CMFCApplication1Dlg::KeyUpMsflexgrid1(short* KeyCode, short Shift)
{
