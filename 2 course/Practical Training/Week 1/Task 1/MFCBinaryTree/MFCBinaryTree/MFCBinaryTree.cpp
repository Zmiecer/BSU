...
// MFCBinaryTree.cpp : Определяет поведение классов для приложения.
//
...
BEGIN_MESSAGE_MAP(CMFCBinaryTreeApp, CWinApp)
	ON_COMMAND(ID_HELP, &CWinApp::OnHelp)
END_MESSAGE_MAP()


// создание CMFCBinaryTreeApp

CMFCBinaryTreeApp::CMFCBinaryTreeApp()
{
...
// Единственный объект CMFCBinaryTreeApp

CMFCBinaryTreeApp theApp;


// инициализация CMFCBinaryTreeApp

BOOL CMFCBinaryTreeApp::InitInstance()
{
