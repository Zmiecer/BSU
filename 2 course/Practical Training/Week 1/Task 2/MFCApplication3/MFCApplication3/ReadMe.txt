...
MFCApplication3Dlg.h, MFCApplication3Dlg.cpp — диалоговое окно
    Эти файлы содержат класс CMFCApplication3Dlg. Этот класс определяет поведение главного диалогового окна приложения. Шаблон диалогового окна находится в файле MFCApplication3.rc, который можно изменять с помощью Microsoft Visual C++.
