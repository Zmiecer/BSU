...
BOOL CMFCApplication3Dlg::OnInitDialog()
{
	...
	grid.AddItem(_T("Test"), varString);
...
BEGIN_EVENTSINK_MAP(CMFCApplication3Dlg, CDialogEx)
	ON_EVENT(CMFCApplication3Dlg, IDC_MSFLEXGRID1, DISPID_KEYUP, CMFCApplication3Dlg::KeyUpMsflexgrid1, VTS_PI2 VTS_I2)
END_EVENTSINK_MAP()


void CMFCApplication3Dlg::KeyUpMsflexgrid1(short* KeyCode, short Shift)
{
