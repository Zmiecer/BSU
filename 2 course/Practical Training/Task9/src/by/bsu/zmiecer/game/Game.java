...
public class Game implements Runnable {
    ...
    public Game()
    {
        ...
        eagle = new Eagle(9.5f * Game.SCALE,15 * Game.SCALE,atlas);
    ...
    private static final float RESPAWN_2_X = 9.5f * SCALE;
    private static final float RESPAWN_3_X = 19 * SCALE;
    ...
    {
        destroyAll();
        player = new Player(7.5f * Game.SCALE, 15 * Game.SCALE, 0, atlas);
        addEntity(player);
        int level = ThreadLocalRandom.current().nextInt(0, 7 + 1);
