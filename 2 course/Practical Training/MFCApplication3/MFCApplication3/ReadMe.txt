...
MFCApplication3Doc.h, MFCApplication3Doc.cpp — документ
    ...
    Документ будет содержать следующие строки:
        Расширение файла:      myf
        Идентификатор типа файла:        MFCApplication3.Document
        Заголовок главного фрейма:  MFCApplication3
        Имя типа документа:       MFCApplication3
        Имя фильтра:         MFCApplication3 Files (*.myf)
        Новое краткое имя файла: MFCApplication3
        Полное имя типа файла: MFCApplication3.Document
