...
public class Enemy extends Tank
{
    public Enemy(float x, float y, int level, TextureAtlas atlas)
    {
        ...
        north = new Heading(8,  0,  1,  1,  NORTH);
        west = new Heading(10,  0,  1,  1,  WEST);
        south = new Heading(12, 0,  1,  1,  SOUTH);
        east = new Heading(14,  0,  1,  1,  EAST);
...
//        alive = false;
        ...
        Game.addEntity(new Explosion(x, y, atlas));
        Game.destroy(this);
    }
