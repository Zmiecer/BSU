================================================================================
    БИБЛИОТЕКА MICROSOFT FOUNDATION CLASS. Обзор проекта MFCTextTransliterator
===============================================================================

Это приложение MFCTextTransliterator автоматически создано с помощью мастера приложений. Это приложение демонстрирует основные принципы использования классов Microsoft Foundation; оно также может использоваться в качестве основы для написания собственных приложений.

В этом файле представлена сводка содержимого всех файлов, входящих в состав приложения MFCTextTransliterator.

MFCTextTransliterator.vcxproj
...
MFCTextTransliterator.vcxproj.filters
...
MFCTextTransliterator.h
    Это основной файл заголовка приложения.
    Он содержит прочие заголовки, относящиеся к проекту (включая Resource.h), а также объявляет класс приложения CMFCTextTransliteratorApp.

MFCTextTransliterator.cpp
    Это основной исходный файл приложения, в котором содержится класс приложения CMFCTextTransliteratorApp.

MFCTextTransliterator.rc
...
res\MFCTextTransliterator.ico
    Файл значка, используемый в качестве значка приложения. Этот значок включен с помощью основного файла ресурсов MFCTextTransliterator.rc.

res\MFCTextTransliterator.rc2
...
res\Toolbar.bmp
    ...
    Начальная панель инструментов и строка состояния, созданные в классе CMainFrame. Измените этот точечный рисунок панели инструментов в редакторе ресурсов и обновите массив IDR_MAINFRAME TOOLBAR в файле MFCTextTransliterator.rc, чтобы добавить кнопки панели инструментов.
/////////////////////////////////////////////////////////////////////////////

Мастер приложений создает один тип документов и одно представление:

MFCTextTransliteratorDoc.h, MFCTextTransliteratorDoc.cpp — документ
    Эти файлы содержат класс CMFCTextTransliteratorDoc. Измените эти файлы, чтобы добавить особые данные документа и реализовать сохранение и загрузку файлов (посредством CMFCTextTransliteratorDoc::Serialize).
    Документ будет содержать следующие строки:
        Расширение файла:      trl
        Идентификатор типа файла:        MFCTextTransliterator.Document
        Заголовок главного фрейма:  MFCTextTransliterator
        Имя типа документа:       MFCTextTranslit
        Имя фильтра:         MFCTextTransliterator Files (*.trl)
        Новое краткое имя файла: MFCTextTranslit
        Полное имя типа файла: MFCTextTransliterator.Document

MFCTextTransliteratorView.h, MFCTextTransliteratorView.cpp — представление документа
    Эти файлы содержат класс CLeftView.
    Объекты CLeftView используются для просмотра объектов CMFCTextTransliteratorDoc.
...
StdAfx.h, StdAfx.cpp
    Эти файлы используются для построения файла предкомпилированного заголовка (PCH) с именем MFCTextTransliterator.pch и файла предкомпилированных типов с именем StdAfx.obj.
...
MFCTextTransliterator.manifest
