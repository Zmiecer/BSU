...
// MFCTextTransliterator.cpp : Определяет поведение классов для приложения.
//
...
BEGIN_MESSAGE_MAP(CMFCTextTransliteratorApp, CWinApp)
	ON_COMMAND(ID_APP_ABOUT, &CMFCTextTransliteratorApp::OnAppAbout)
...
// создание CMFCTextTransliteratorApp

CMFCTextTransliteratorApp::CMFCTextTransliteratorApp()
{
	...
	SetAppID(_T("MFCTextTransliterator.AppID.NoVersion"));

	// TODO: добавьте код создания,
	// Размещает весь важный код инициализации в InitInstance
}

// Единственный объект CMFCTextTransliteratorApp

CMFCTextTransliteratorApp theApp;


// инициализация CMFCTextTransliteratorApp

BOOL CMFCTextTransliteratorApp::InitInstance()
{
	...
	pDocTemplate = new CSingleDocTemplate(
		IDR_MAINFRAME,
		RUNTIME_CLASS(CMFCTextTransliteratorDoc),
...
int CMFCTextTransliteratorApp::ExitInstance()
{
...
// обработчики сообщений CMFCTextTransliteratorApp
...
void CMFCTextTransliteratorApp::OnAppAbout()
{
	CAboutDlg aboutDlg;
	aboutDlg.DoModal();
}
